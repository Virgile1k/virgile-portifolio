...
// import { BlogState } from '../Redux/Features/blogs/deleteblog';
...
//   const blogs = useSelector((state: BlogState) => state.blogs.blogs);
...
//     dispatch(deleteBlog(_id) as any);
//   };
...
//         </div>
//         {blogs.map((blog: Blog) => (
//           <div key={blog._id} className="grid grid-cols-6 gap-2 items-center text-center py-2 px-4 text-teal-50 font-bold">
